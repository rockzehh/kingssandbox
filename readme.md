...
Global plugin version is *1.0.0.0*.
...
sm_colorlist|Displays the color list.|sm_colors|Client|[Color List](https://raw.githubusercontent.com/rockzehh/kingssandbox/master/addons/sourcemod/data/kingssandbox/exports/colorlist.txt)
sm_commandlist|Displays the command list.|sm_cmds, sm_commands|Client|[Command List](https://raw.githubusercontent.com/rockzehh/kingssandbox/master/addons/sourcemod/data/kingssandbox/exports/commandlist.txt)
...
sm_emitterlist|Displays the emitter list.|sm_emitters|Client|[Emitters List](https://rockzehh.github.io/kingssandbox/emitters.html)
...
sm_proplist|Displays the prop list.|sm_props|Client|[Prop List](https://raw.githubusercontent.com/rockzehh/kingssandbox/master/addons/sourcemod/data/kingssandbox/exports/proplist.txt)
...
For the most current command list, [click here](https://raw.githubusercontent.com/rockzehh/kingssandbox/master/addons/sourcemod/data/kingssandbox/exports/commandlist.txt).
